...
const MyBids = () => {
  ...
  useEffect(() => {
    const fetchBidsData = async() => {
      try{
        const res = await axiosPublic.get(`/get-my-bids?email=${user?.email}`);
  ...
  return (
    <section className='container px-4 mx-auto my-12'>
      <div className='flex items-center gap-x-3'>
        ...
        <span className='px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full '>{bids ? bids.length : 0} Bid</span>
      </div>
